...
/*         current_Roll_Angle = 
    ...
    /*
        alt. för att rotera vågrätt: transform.Rotate(transform.up, Input.getAxis("Mouse X)) 
        // deltaTime INTE så bra för mus-input (why?)

        för vågrätt:
                private float pivot (central punkt?)
